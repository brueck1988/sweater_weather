...
RSpec.describe ImageCredit do
  it 'exists' do
    ...
    image_credit = ImageCredit.new(data)
    expect(image_credit).to be_a(ImageCredit)
    expect(image_credit.author).to eq('Ryan De Hamer')
    expect(image_credit.logo).to eq('https://unsplash.com/@rdehamer')
    expect(image_credit.source).to eq('unsplash.com')
  end
end
