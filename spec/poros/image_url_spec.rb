...
RSpec.describe ImageUrl do
  it "exists" do
    ...
    image_url = ImageUrl.new(background_query, background_data)
    expect(image_url).to be_a(ImageUrl)
    expect(image_url.image_url).to eq("https://images.unsplash.com/photo-1619856699906-09e1f58c98b1?ixid=MnwyMzk1NjR8MHwxfHNlYXJjaHwxfHxkZW52ZXIlMkMlMjBjb3xlbnwwfHx8fDE2MjM3MDg1Nzk&ixlib=rb-1.2.1")
    expect(image_url.location).to eq("denver, co")
  end
end
