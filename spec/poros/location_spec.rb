    ...
    data = { info: { statuscode: 0,
             ...
             results: [{ providedLocation: { location: 'denver,co' },
                         locations: [{ street: '',
                                       ...
                                       mapUrl: 'http://www.mapquestapi.com/staticmap/v5/map?key=sucuI80d9QpTtTCkXxdBkixmMPcVlWdW&type=map&size=225,160&locations=39.738453,-104.984853|marker-sm-50318A-1&scalebar=true&zoom=12&rand=-1532269117' }] }] }
